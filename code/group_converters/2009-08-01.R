...
groups <- read_excel("przewalski/data/groups/2009.xlsx", sheet = "08.01")
...
groups_exp$date<-rep((as.Date("2009-08-01")),times=(nrow(groups_exp)))
...
write_xlsx(groups_exp,"przewalski/data/groups/long/2009-08-01.xlsx")
