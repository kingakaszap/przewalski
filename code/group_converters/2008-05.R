...
groups <- read_excel("przewalski/data/groups/2008.xlsx", sheet = "05.01")
...
groups_exp$date<-rep((as.Date("2008-05-01")),times=(nrow(groups_exp)))

write_xlsx(groups_exp,"przewalski/data/groups/long/2008-05.xlsx")
