...
groups <- read_excel("przewalski/data/groups/2012.xlsx", sheet = 4)
...
groups_exp$date<-rep((as.Date("2012-03-06")),times=(nrow(groups_exp)))
...
write_xlsx(groups_exp,"przewalski/data/groups/long/2012-03-06.xlsx")
