...
groups <- read_excel("przewalski/data/groups/2011.xlsx", sheet = "11.13")
...
groups_exp$date<-rep((as.Date("2011-11-13")),times=(nrow(groups_exp)))
...
write_xlsx(groups_exp,"przewalski/data/groups/long/2011-11-13.xlsx")
