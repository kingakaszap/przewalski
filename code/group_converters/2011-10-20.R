...
groups <- read_excel("przewalski/data/groups/2011.xlsx", sheet = "10.20")
...
groups_exp$date<-rep((as.Date("2011-10-20")),times=(nrow(groups_exp)))
...
write_xlsx(groups_exp,"przewalski/data/groups/long/2011-10-20.xlsx")
