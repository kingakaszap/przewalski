...
groups <- read_excel("przewalski/data/groups/2012.xlsx", sheet = 12)
...
groups_exp$date<-rep((as.Date("2012-05-19")),times=(nrow(groups_exp)))
...
write_xlsx(groups_exp,"przewalski/data/groups/long/2012-05-19.xlsx")
